...
class MaskApply {
  ...
  public static printCompetenceFromTimestamp(timestamp: Date | number | string): string {
    var date: Date | number | string;
  ...
  public static printDateTimeFromTimestamp(timestamp: Date | number | string): string {
    var date: Date | number | string;
